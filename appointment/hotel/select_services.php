...
<br><h3>Select Additional Services</h3><br><br>
    <form action="/FurCareHub/appointment/hotel/store.php" method="POST">
        ...
        <input type="hidden" name="additional_days" value="<?php echo $additional_days; ?>"> <!-- Separate additional days -->
        <input type="hidden" name="additional_hours" value="<?php echo $additional_hours; ?>"> <!-- Separate additional hours -->
