...
if (!isset($_POST['pet_id'], $_POST['room_id'], $_POST['check_in'], $_POST['duration_id'], $_POST['check_out'])) {
...
$apttype_id = 1; // Assuming apttype_id 1 is for daycare
$status_id = 3; // Assuming status_id 3 is for a new appointment
$overtime_hours = 0; // Assuming no overtime hours initially
